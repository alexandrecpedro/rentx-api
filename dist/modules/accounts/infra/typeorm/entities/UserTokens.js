...
let UserTokens = (_dec = (0, _typeorm.Entity)('users_tokens'), _dec2 = Reflect.metadata("design:type", Function), _dec3 = Reflect.metadata("design:paramtypes", []), _dec4 = (0, _typeorm.PrimaryColumn)('uuid'), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.Column)({
  type: 'varchar',
  nullable: false
}), _dec7 = Reflect.metadata("design:type", String), _dec8 = (0, _typeorm.ManyToOne)(() => _User.User), _dec9 = (0, _typeorm.JoinColumn)({
  name: 'user_id'
}), _dec10 = Reflect.metadata("design:type", typeof _User.User === "undefined" ? Object : _User.User), _dec11 = (0, _typeorm.Column)({
  type: 'varchar',
  nullable: true
}), _dec12 = Reflect.metadata("design:type", String), _dec13 = (0, _typeorm.Column)({
  type: 'timestamp'
}), _dec14 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec15 = (0, _typeorm.CreateDateColumn)({
  type: 'timestamp',
  default: () => 'CURRENT_TIMESTAMP(6)'
}), _dec16 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = class UserTokens {
  constructor() {
