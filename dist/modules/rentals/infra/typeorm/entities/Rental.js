...
let Rental = (_dec = (0, _typeorm.Entity)('rentals'), _dec2 = Reflect.metadata("design:type", Function), _dec3 = Reflect.metadata("design:paramtypes", []), _dec4 = (0, _typeorm.PrimaryColumn)(), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.ManyToOne)(() => _Car.Car), _dec7 = (0, _typeorm.JoinColumn)({
  name: 'car_id'
}), _dec8 = Reflect.metadata("design:type", typeof _Car.Car === "undefined" ? Object : _Car.Car), _dec9 = (0, _typeorm.Column)({
  type: 'varchar',
  nullable: true
...
}), _dec14 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec15 = (0, _typeorm.Column)({
  type: 'timestamp',
  nullable: true
}), _dec16 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec17 = (0, _typeorm.Column)({
  type: 'timestamp',
  nullable: false
}), _dec18 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec19 = (0, _typeorm.Column)({
  type: 'decimal',
  precision: 7,
  scale: 2,
  nullable: true
}), _dec20 = Reflect.metadata("design:type", Number), _dec21 = (0, _typeorm.CreateDateColumn)({
  type: 'timestamp',
  default: () => 'CURRENT_TIMESTAMP(6)'
}), _dec22 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec23 = (0, _typeorm.UpdateDateColumn)({
  type: 'timestamp',
  default: () => 'CURRENT_TIMESTAMP(6)',
  onUpdate: 'CURRENT_TIMESTAMP(6)'
}), _dec24 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = class Rental {
  constructor() {
