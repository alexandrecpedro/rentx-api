...
let Car = (_dec = (0, _typeorm.Entity)('cars'), _dec2 = Reflect.metadata("design:type", Function), _dec3 = Reflect.metadata("design:paramtypes", []), _dec4 = (0, _typeorm.PrimaryColumn)(), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.Column)({
  type: 'varchar',
  nullable: false
  ...
  type: 'varchar',
  nullable: false
}), _dec19 = Reflect.metadata("design:type", String), _dec20 = (0, _typeorm.ManyToOne)(() => _Category.Category), _dec21 = (0, _typeorm.JoinColumn)({
  name: 'category_id'
}), _dec22 = Reflect.metadata("design:type", typeof _Category.Category === "undefined" ? Object : _Category.Category), _dec23 = (0, _typeorm.Column)({
  type: 'varchar',
  nullable: true
}), _dec24 = Reflect.metadata("design:type", String), _dec25 = (0, _typeorm.ManyToMany)(() => _Specification.Specification), _dec26 = (0, _typeorm.JoinTable)({
...
}), _dec27 = Reflect.metadata("design:type", Array), _dec28 = (0, _typeorm.CreateDateColumn)({
  type: 'timestamp',
  default: () => 'CURRENT_TIMESTAMP(6)'
}), _dec29 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = class Car {
  constructor() {
